...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libobjcryst-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libobjcryst-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libobjcryst
# for installing globally
pixi global install libobjcryst
```
...
It is possible to list all of the versions of `libobjcryst` available on your platform:
...
```
pixi search libobjcryst --channel conda-forge
```
